                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('kythi.update', $viewData['kyThi']->getMaKT()) }}" method="POST" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                    <div class="table-responsive mt-4">
                                        <div class="ms-4 d-flex align-items-center">
                                            <label for="tenKT" class="me-0 mb-0" style="min-width: 120px;"><strong>Tên kỳ thi:</strong></label>
                                    ...
                                    <div class="table-responsive mt-4">
                                        <div class="ms-4">
                                            ...
                                            <div class="row">
                                                @php
                                                    $selectedDeThi = old('de_thi_ids', $viewData['chiTietKyThi']->pluck('maDT')->toArray());
                                                @endphp
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" 
                                                                   ...
                                                                   {{ in_array($deThi->getMaDT(), $selectedDeThi) ? 'checked' : '' }}>
                                    ...
                                    <div class="table-responsive mt-4">
                                        <div class="ms-4 d-flex align-items-center">
                                            ...
                                            <textarea id="moTa" name="moTa" class="form-control">{{ old('moTa', $viewData['kyThi']->getMoTa()) }}</textarea>
                                        </div>
                                    </div>
