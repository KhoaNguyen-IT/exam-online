...
@section('content')
    <div class="profile-page-container">
        <div class="profile-card">
            <form class="profile-form" action="{{ route('teacher.updateProfile', ['id' => $viewData['user']->maTK]) }}"
                ...
                <div class="avatar-section">
                    ...
                    @endif
                    <button type="button"
                        class="change-avatar-button">{{ $viewData['user']->anhDaiDien ? 'Đổi ảnh đại diện' : 'Thêm ảnh đại diện' }}</button>
